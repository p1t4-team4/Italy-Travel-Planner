...
if (localStorage.getItem('naples_activities') != undefined){
    activities = JSON.parse(localStorage.getItem('naples_activities'));
}

if (localStorage.getItem('naples_restaurants') != undefined){
  restaurants = JSON.parse(localStorage.getItem('naples_restaurants'));
}

if (localStorage.getItem('naples_places') != undefined){
  places = JSON.parse(localStorage.getItem('naples_places'));
}

if (localStorage.getItem('naples_budget') != undefined){
  budget = JSON.parse(localStorage.getItem('naples_budget'));
}

if (localStorage.getItem('naples_total') != undefined){
  total = localStorage.getItem('naples_total');
}
...
activitiesForm.addEventListener('submit', function (event) {
    ...
    localStorage.setItem('naples_activities', JSON.stringify(activities));
...
restaurantsForm.addEventListener('submit', function (event) {
  ...
  localStorage.setItem('naples_restaurants', JSON.stringify(restaurants));
...
placesForm.addEventListener('submit', function (event) {
  ...
  localStorage.setItem('naples_places', JSON.stringify(places));
  placesInput.value = '';
...
budgetForm.addEventListener('submit', function (event) {
  ...
  localStorage.setItem('naples_budget', JSON.stringify(budget));
  localStorage.setItem('naples_total', JSON.stringify(total));
  itemInput.value = '';
  priceInput.value = '';
  renderBudget();
});
...
journalForm.addEventListener('submit', function (event) {
  ...
  localStorage.setItem('naples_JournalSave', journalText);
});
...
function renderJournal(){
  journalInput.value = localStorage.getItem('naples_JournalSave');
}