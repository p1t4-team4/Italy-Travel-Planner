...
if (localStorage.getItem('venice_activities') != undefined){
    activities = JSON.parse(localStorage.getItem('venice_activities'));
}

if (localStorage.getItem('venice_restaurants') != undefined){
  restaurants = JSON.parse(localStorage.getItem('venice_restaurants'));
}

if (localStorage.getItem('venice_places') != undefined){
  places = JSON.parse(localStorage.getItem('venice_places'));
}

if (localStorage.getItem('venice_budget') != undefined){
  budget = JSON.parse(localStorage.getItem('venice_budget'));
}

if (localStorage.getItem('venice_total') != undefined){
  total = localStorage.getItem('venice_total');
}
...
activitiesForm.addEventListener('submit', function (event) {
    ...
    localStorage.setItem('venice_activities', JSON.stringify(activities));
...
restaurantsForm.addEventListener('submit', function (event) {
  ...
  localStorage.setItem('venice_restaurants', JSON.stringify(restaurants));
...
placesForm.addEventListener('submit', function (event) {
  ...
  localStorage.setItem('venice_places', JSON.stringify(places));
  placesInput.value = '';
...
budgetForm.addEventListener('submit', function (event) {
  ...
  localStorage.setItem('venice_budget', JSON.stringify(budget));
  localStorage.setItem('venice_total', JSON.stringify(total));
  itemInput.value = '';
  priceInput.value = '';
  renderBudget();
});
...
journalForm.addEventListener('submit', function (event) {
  ...
  localStorage.setItem('venice_JournalSave', journalText);
});
...
function renderJournal(){
  journalInput.value = localStorage.getItem('venice_JournalSave');
}