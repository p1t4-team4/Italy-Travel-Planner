...
if (localStorage.getItem('rome_activities') != undefined){
    activities = JSON.parse(localStorage.getItem('rome_activities'));
}

if (localStorage.getItem('rome_restaurants') != undefined){
  restaurants = JSON.parse(localStorage.getItem('rome_restaurants'));
}

if (localStorage.getItem('rome_places') != undefined){
  places = JSON.parse(localStorage.getItem('rome_places'));
}

if (localStorage.getItem('rome_budget') != undefined){
  budget = JSON.parse(localStorage.getItem('rome_budget'));
}

if (localStorage.getItem('rome_total') != undefined){
  total = localStorage.getItem('rome_total');
}
...
activitiesForm.addEventListener('submit', function (event) {
    ...
    localStorage.setItem('rome_activities', JSON.stringify(activities));
...
restaurantsForm.addEventListener('submit', function (event) {
  ...
  localStorage.setItem('rome_restaurants', JSON.stringify(restaurants));
...
placesForm.addEventListener('submit', function (event) {
  ...
  localStorage.setItem('rome_places', JSON.stringify(places));
  placesInput.value = '';
...
budgetForm.addEventListener('submit', function (event) {
  ...
  localStorage.setItem('rome_budget', JSON.stringify(budget));
  localStorage.setItem('rome_total', JSON.stringify(total));
  itemInput.value = '';
  priceInput.value = '';
  renderBudget();
});
...
journalForm.addEventListener('submit', function (event) {
  ...
  localStorage.setItem('rome_JournalSave', journalText);
});
...
function renderJournal(){
  journalInput.value = localStorage.getItem('rome_JournalSave');
}